/*
	...
	This sample demonstrates how to capture the H264/H265 stream with JPEG snap: main(h264/h265 + jpeg), sec(h265/h264)
			(note：
					chn0----        chn3----        chn6----        chn0----
...
#define TAG "sample-Encoder-video-jpeg"
